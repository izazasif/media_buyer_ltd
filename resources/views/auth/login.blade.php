...
<head>
    ...
    <title>Media Byer Ltd</title>
    <link rel="icon" href="{{ asset('img/robi.png') }}">
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ url('/') }}/resource/plugins/iCheck/square/blue.css">
...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="login-box-body">
            <div class="login-logo">
                <img class="brand" src="{{ url('/') }}/img/robi.png" style="height:70px;" alt="bootstraper logo">
            </div>
            <p class="login-box-msg">Sign in to start your session</p>

            <form role="form" method="POST" action="{{route('system.login')}}">
                @csrf
    ...
    <!-- iCheck -->
    <script src="{{ url('/') }}/resource/plugins/iCheck/icheck.min.js"></script>
    <script>
