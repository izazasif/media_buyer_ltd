...
Route::get('/loginsytem2',[App\Http\Controllers\AuthController::class,'loginSystem'])->name('system.login');
Route::post('/loginsytem2',[App\Http\Controllers\AuthController::class,'login'])->name('system.login');
